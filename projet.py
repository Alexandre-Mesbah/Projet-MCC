        ...
        while i < len(lignes):
            ...
            if ligne.startswith("name:"):
                ...
                if len(reste_instruction) != 2 * nb_rubans:
                    raise ValueError(
                        "Transition invalide : le nombre de symboles ecrits et "
                        "de directions ne correspond pas au nombre de rubans."
                    )
                ...
                if nb_rubans == 1:
                    ...
                    alphabet.add(symboles_lus[0])
                    alphabet.add(symboles_ecrits[0])
                else:
